...
SUBTYPE POSITION IS INTEGER RANGE 0 .. 150;
	...
	BEGIN
		IF COMMAND = '.' THEN
			...
			GRAPH.ADD_NODE(TOWER_FIRST_NAME, TOWER_SECOND_NAME, "ADD");
		ELSIF COMMAND = '?' THEN
			ADA.TEXT_IO.PUT_LINE("QUERY : " & TOWER_FIRST_NAME & " TO " & TOWER_SECOND_NAME);
			GRAPH.ADD_NODE(TOWER_FIRST_NAME, TOWER_SECOND_NAME, "QUERY");
			GRAPH_STRUCT(TOWER_FIRST_NAME, TOWER_SECOND_NAME, "ADD");
		ELSIF COMMAND = '?' THEN
			ADA.TEXT_IO.PUT_LINE("QUERY : " & TOWER_FIRST_NAME & " TO " & TOWER_SECOND_NAME);
			GRAPH_STRUCT(TOWER_FIRST_NAME, TOWER_SECOND_NAME, "QUERY");
		END IF;
    END PROCESS_STRING;
