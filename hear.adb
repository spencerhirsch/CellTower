...
SUBTYPE POSITION IS INTEGER RANGE 0 .. 150;
	...
	FUNCTION DO_TOWERS_CONNECT ( TOWER_ONE : TOWERS_ACCESS; TOWER_TWO : TOWERS_ACCESS ) RETURN BOOLEAN IS
	BEGIN
		RETURN TRUE;
	END DO_TOWERS_CONNECT;
	...
	BEGIN
		...
		ELSIF COMMAND = '?' THEN
			...
			IF FIRST_TOWER_EXISTS AND SECOND_TOWER_EXISTS THEN
				...
				ADA.TEXT_IO.PUT_LINE(BOOLEAN'IMAGE(DO_TOWERS_CONNECT(TOWER_SOURCE, TOWER_CONNECTED)));
			ELSE
				ADA.TEXT_IO.PUT_LINE("ONE OF THE TOWERS DONT EXIST");
			END IF;
